...
const Operation = (props: any) => {
    ...
    const isPending = values.find((a: any) => a.name === 'block_level').value === -1;
    let title: any = t('components.entityModal.details', { title: isPending ? 'Pending Operation' : 'Operation' });
